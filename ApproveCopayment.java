 ...
 */
    ...
    class Encryption {
        private Key key;
        /**
         * Constructor to initialize the soft_pack.Encryption class with a key.
         */
        Encryption(){
            this.key = new Key();}
        /**
 ...
 */
    ...
    class Key {
        ...
        private Cipher user_cipher;
        /**
         * Default constructor for the soft_pack.Key class.
         */
        Key() {
        }
        /**
 ...
 */
    ...
    class Decryption {
        private Key key;
        /**
         * Constructor to initialize the soft_pack.Decryption class with a key.
         */
        Decryption(){
            this.key = new Key();
        }
    ...
    class CustomerNotes {
        ...
        /**
         * Default constructor for soft_pack.CustomerNotes class.
         */
        CustomerNotes() {}
        ...
        /**
         * Decrypts all encrypted attributes using the provided soft_pack.Decryption object.
         * @param decryption The soft_pack.Decryption object to use for decryption.
         * @throws Exception if an error occurs during decryption.
         */
        ...
        /**
         * Encrypts all attributes using the provided soft_pack.Encryption object.
         * @param encryption The soft_pack.Encryption object to use for encryption.
         * @throws Exception if an error occurs during encryption.
         */
    ...
    class CustomerNotesArrays {
        ...
        /**
         * Constructor to initialize the soft_pack.CustomerNotesArrays class with sample data.
